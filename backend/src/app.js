...
utils.getOidcDiscovery().then((discovery) => {
  ...
  addLoginPassportUse(
    discovery,
    'oidcBceid',
    config.get('server:frontend') + '/api/auth/callback_bceid',
    'basic-bceid'
  );
  addLoginPassportUse(
    discovery,
    'oidcBceidActivateUser',
    config.get('server:frontend') + '/api/auth/callback_activate_user',
    'basic-bceid'
  );
  addLoginPassportUse(
    discovery,
    'oidcBceidActivateDistrictUser',
    config.get('server:frontend') + '/api/auth/callback_activate_district_user',
    'basic-bceid'
  );
