  ...
  <v-container>
    ...
    <div v-else>
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >Boarding Safety and Supervision Policy
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >Student Conduct/Standards/Discipline Policy
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label class="ml-5"
            ...
            <span class="orange"
              >iosas_policyincludepermanentschoolclosure</span
            >
          </v-label>
        </v-col>
        <v-col cols="4">
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >Graduation Program Credits policy (if applicable)
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >Homeschooling policy (if applicable)
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >International Student policies (if applicable)
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label class="ml-5"
            ...
            <span class="orange"
              >iosas_learningassistanceforspecialstudents</span
            >
          </v-label>
        </v-col>
        <v-col cols="4">
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label class="ml-5"
            ...
            <span class="orange"
              >iosas_willhavecompletioncertificatepolicy</span
            >
          </v-label>
        </v-col>
        <v-col cols="4">
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            >Testing Drinking Water for Lead Content Policy
      ...
      <v-row align="center">
        <v-col cols="8">
          <v-label
            ...
            <span class="orange"
              >iosas_teacherandprincipalevaluationpolicy</span
            >
          </v-label>
        </v-col>
        <v-col cols="4">
