  ...
  <v-conatiner>
    ...
    <v-row align="center">
      <v-col cols="8">
        ...
        <v-label
          >If the proposed school is intending to seek funding, are you familiar
          with Grants to Independent Schools Policy?
        </v-label>
      </v-col>
      <v-col cols="4">
        <v-radio-group
    ...
    <v-row align="center">
      <v-col cols="8">
        <v-label
          ...
          from a bank or surety provider of the authority's eligibility to meet
          the bonding requirements of the Independent School Regulation
    ...
    <v-label class="block"
      >Has the school applicant’s authority obtained written confirmation from a
      financial institution or surety provider of their eligibility to obtain a
      bond in the form of an irrevocable letter of credit or surety bond in the
      amount of $100,000, consistent with requirements of the Independent School
      Regulation?
      <br />
      Specifically:
      <ul class="ml-10">
    ...
    <v-row align="center">
      <v-col cols="8">
        <v-label
          >Please note that the Ministry will not issue an Interim Certification
          until the required bonding instrument has been provided by the Group 4
          applicant.</v-label
        >
      </v-col>
      <v-col cols="4">
    ...
    <br />
    <v-label
      >Has the authority developed a fees and tuition refund policy that ensures
      refunds in the event the school is unable to obtain or maintain a Group 4
      Certificate of Classification in the first year of operation?
    </v-label>
    <v-row>
