            ...
            <v-window v-model="tab">
              <v-window-item key="General" value="General">
                ...
                <v-label
                  ><strong>
                    ...
                    Schedule of the Independent School Act, which requires that:
                  </strong>
                </v-label>
                <v-row>
                  <br />
                ...
                <v-row>
                  <v-col cols="12">
                    <v-label>
                      <ol start="3">
                        <li>
                          The authority complies with the Independent School Act
                          and its regulations.
                        </li>
                      </ol>
                    </v-label>
              ...
              >
                ...
                <v-label
                  ...
                  nature of program (international/Montessori/Waldorf/IB/other)
                  and plans for future years.</v-label
                >
                <v-row>
                  <v-col cols="12">
                    <v-textarea
                ...
                <v-row>
                  <v-col cols="12">
                    <v-label
                      ...
                      second or subsequest year(s) of operation?
                    </v-label>
                    <v-radio-group
                      v-model="groupOneBoolRadioGroup"
                      color="#003366"
              ...
              <v-window-item key="School Authority" value="School Authority">
                ...
                <v-label
                  >Please indicate under which legislation your School Authority
                  is incorporated:</v-label
                >
                <v-row>
                  <v-col cols="12" sm="12" md="6" xs="12">
                    <v-checkbox
              ...
              <v-window-item key="Student Enrolment" value="Student Enrolment">
                <h4>Projected Student Enrolment</h4>
                <v-label
                  ><strong>
                    NOTE: A new school must have 10 or more school age students
                    who are enrolled with the school and reported as 1.00 FTE
                    each in accordance with the 1701 instructions for
              ...
              <v-window-item key="School Semester" value="School Semester">
                ...
                <v-label
                  >Schools Seeking Group 1, 2 and 4 only. Please select however
                  many fit the intended school.</v-label
                >
                <v-row>
              ...
              >
                ...
                <v-label
                  ...
                  program requirements determined by the Minister, as specified
                  in the Educational Standards Order.</v-label
                >
                <br />
                <br />
                ...
                <v-row align="center">
                  <v-col cols="8">
                    ...
                    <v-label
                      >If the proposed school is intending to seek funding, are
                      you familiar with Grants to Independent Schools Policy?
                    </v-label>
                  </v-col>
                  <v-col cols="4">
                    <v-radio-group
                ...
                <br />
                <v-label
                  >Has the authority developed a fees and tuition refund policy
                  that ensures refunds in the event the school is unable to
                  obtain or maintain a Group 4 Certificate of Classification in
              ...
              >
                ...
                <v-label
                  >At this time does the proposed school intend on enrolling any
                  of the following students? (Check all that apply)</v-label
                >
                <v-row>
                  <v-col cols="6" sm="6" md="4" xs="6">
                    <v-checkbox
              ...
              >
                ...
                <br />
                <v-label>
                  The school principal/head of school and all teachers teaching
                  a subject that is reported out on student report cards must
                  hold valid British Columbia teaching credentials issued by the
                  Teacher Certification Branch (TCB). Initial certification of
                  Group 2 and Group 4 schools will typically not be possible for
                  schools employing teachers relying on a Letter of Permission
                  as certification.
                </v-label>
                <br />
                <br />
                ...
                <v-row align="center">
                  <v-col cols="8">
                    <v-label
                      ...
                      checks for employees who are working with children and who
                      are not certified teachers, such as: administrative
                      assistants, business managers, secretaries, counsellors,
                      teacher assistants, health nurses, consultants,
                      specialists, janitors, and persons assigned other special
                      tasks?</v-label
                    >
                  </v-col>
                  <v-col cols="4">
              ...
              <v-window-item key="Submissions" value="Submissions">
                ...
                <v-row align="center">
                  <v-col cols="8">
                    <v-label
                      >Business Plan with required financial information (Part A
                      and B) (Interview Checklist (PDF))</v-label
                    >
                  </v-col>
                  <v-col cols="4">
                    <v-radio-group
